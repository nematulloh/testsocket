  ...
  <b-container fluid>
    <b-row>
      ...
      <b-col sm="3" md="3" class="my-1">
        <button @click="Href('/chiqim/create')" class="btn btn-primary mybtn">
          {{ $t("Қўшиш") }}
        </button>
    ...
    >
      ...
      <template #cell(actions)="row">
        <router-link
          class="mybtn btn"
          :to="{ path: '/chiqim/update/' + row.item.id }"
...
export default {
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: "summa", label: "Сумма", sortable: true, class: "text-center" },

        // {
        //   key: "pay_type",
        //   label: this.$t("Тўлов тури"),
        //   sortable: true,
        //   class: "text-center"
        // },
  ...
  methods: {
    filterFunction,
    Update(record, index) {
      this.$router.push({ path: '/chiqim/update/' + record.id});
    },
    Data() {
      let self = this;
      axios({
