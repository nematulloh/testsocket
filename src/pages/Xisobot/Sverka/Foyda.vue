          ...
          <div class="wrap-table100">
            <div class="table100 ver1 m-b-110">
                ...
                <table>
                  <thead>
                    <tr class="row100 head">
                      ...
                      <th class="cell100 column2">{{ $t("Вақт") }}</th>
                      <th class="cell100 column2">{{ $t("Сони") }}</th>
                      <th class="cell100 column2">{{ $t("Тан нарх") }}</th>
                      <th class="cell100 column2">
                        {{ $t("Тан нарх сумма") }}
                      </th>
                      <th class="cell100 column2">{{ $t("Сотиш нарх") }}</th>
                      <th class="cell100 column2">{{ $t("Сотиш сумма") }}</th>
                      <th class="cell100 column2">{{ $t("Фойда нарх") }}</th>
                      <th class="cell100 column2">{{ $t("Фойда") }}%</th>

                      <th class="cell100 column2">{{ $t("Фойда сумма") }}</th>
                    </tr>
                  </thead>
                </table>
              </div>
                  ...
                  <tr>
                    ...
                    <td class="cell100 column2 kol">
                      <span v-if="results.begin">{{
                        results.begin.balance | numFormat
                      }}</span>
                    </td>
                    <td class="cell100 column4 kol" colspan="2">
                      <span v-if="results.begin">{{
                        results.begin.total_body_summa | numFormat
                      }}</span>
                    </td>
                    <td class="cell100 column4 kol" colspan="2">
                      <span v-if="results.begin">{{
                        results.begin.total_sold_summa | numFormat
                      }}</span>
                    </td>
                    <td class="cell100 column4 kol" colspan="2">
                      <span v-if="results.begin">{{
                        results.begin.total_profit_percent | numFormat
                      }}</span>
                    </td>
                    <td class="cell100 column2 kol">
                      <span v-if="results.begin">{{
                        results.begin.total_profit_summa | numFormat
                      }}</span>
                    </td>
                  </tr>
                </table>
                    ...
                    >
                      ...
                      <td class="cell100">
                        <router-link
                          ...
                          >{{ Datetime(item.datetime) }}</router-link
                        >
                      </td>
                      <td class="cell100 column2 kol">
                        <router-link
                          ...
                          >{{ item.count | numFormat }}</router-link
                        >
                      </td>
                      <td class="cell100 column2 kol">
                        <router-link
                          ...
                          >{{ item.body_price | numFormat }}</router-link
                        >
                      </td>
                      <td class="cell100 column2 kol">
                        <router-link
                          ...
                          >{{ item.body_summa | numFormat }}</router-link
                        >
                      </td>
                      <td class="cell100 column2 kol">
                        <router-link
                          ...
                          >{{ item.sold_price | numFormat }}</router-link
                        >
                      </td>
                      <td class="cell100 column2 kol">
                        <router-link
                          ...
                          >{{ item.sold_summa | numFormat }}</router-link
                        >
                      </td>
                      <td class="cell100 column2 kol">
                        <router-link
                          ...
                          >{{ item.profit_price | numFormat }}</router-link
                        >
                      </td>
                      <td class="cell100 column2 kol">
                        <router-link
                          ...
                          >
                          <span v-if="parseInt(item.profit_percent)>=0">
                          {{ parseFloat(item.profit_percent).toFixed(0) }}
                        </span>
                        <span v-else>
                          0
                        </span>
                      ...
                      <td class="cell100 column2 kol">
                        <router-link
                          ...
                          >{{ item.profit_summa | numFormat }}</router-link
                        >
                      </td>
                    </tr>
                  </tbody>
              ...
              <div class="table100-body summatable1">
                <table>
                  <tr>
                    <td colspan="3" class="cell100 ">{{ $t("Жами") }}</td>
                    <td class="cell100 column2 kol">
                      <span v-if="results.summ">{{
                        results.summ.balance | numFormat
                      }}</span>
                    </td>
                    <td class="cell100 column4 kol" colspan="2">
                      <span v-if="results.summ">{{
                        results.summ.total_body_summa | numFormat
                      }}</span>
                    </td>
                    <td class="cell100 column4 kol" colspan="2">
                      <span v-if="results.summ">{{
                        results.summ.total_sold_summa | numFormat
                      }}</span>
                    </td>
                    <td class="cell100 column4 kol" colspan="2">
                      <span v-if="results.summ && parseInt(results.summ.total_profit_percent)>=0">{{
                        parseFloat(results.summ.total_profit_percent).toFixed(0)
                      }}</span>
                      <span v-else>
                        0
                      </span>
                    ...
                    <td class="cell100 column2 kol">
                      <span v-if="results.summ">{{
                        results.summ.total_profit_summa | numFormat
                      }}</span>
                    </td>
                  </tr>
                </table>
                  ...
                  <tr>
                    ...
                    <td class="cell100 column2 kol">
                      <span v-if="results.end">{{
                        results.end.balance | numFormat
                      }}</span>
                    </td>
                    <td class="cell100 column4 kol" colspan="2">
                      <span v-if="results.end">{{
                        results.end.total_body_summa | numFormat
                      }}</span>
                    </td>
                    <td class="cell100 column4 kol" colspan="2">
                      <span v-if="results.end">{{
                        results.end.total_sold_summa | numFormat
                      }}</span>
                    </td>
                    <td class="cell100 column4 kol" colspan="2">
                      <span v-if="results.end && parseInt(results.end.total_profit_percent)>=0">{{
                        parseFloat(results.end.total_profit_percent).toFixed(0)
                      }}</span>
                      <span v-else>0</span>
                    </td>
                    <td class="cell100 column2 kol">
                      <span v-if="results.end">{{
                        results.end.total_profit_summa | numFormat
                      }}</span>
                    </td>
                  </tr>
                </table>
    ...
    Send() {
      ...
      axios({
        ...
        self.results.data.forEach(function(key, value) {
          self.results.summ.balance += parseInt(key.count);
          self.results.summ.total_body_summa += parseInt(key.body_summa);
          self.results.summ.total_sold_summa += parseInt(key.sold_summa);
          self.results.summ.total_profit_summa += parseInt(key.profit_summa);
        });
        self.results.summ.total_profit_percent +=
          (self.results.summ.total_profit_summa /
            self.results.summ.total_body_summa) *
          100;
      });
    }
  }
